...
public class YamlWeatherRepository extends TripScopedYamlRepository<WeatherRecord> implements WeatherRepository {

    public YamlWeatherRepository(YamlStore store, YamlPaths paths, TripLocks locks) {
