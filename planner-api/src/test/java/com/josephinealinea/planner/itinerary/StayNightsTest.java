...
class StayNightsTest {
    ...
    private ItineraryItem createThreeNightStay() {
        return service.create(TRIP_ID, USER_ID, new ItineraryService.Input(null, ChecklistCategory.LODGING, "Hotel in Cusco", LocalDateTime.of(2026, 10, 25, 15, 0), LocalDateTime.of(2026, 10, 28, 11, 0), null, new BigDecimal("240.00"), "USD", List.of()));
    }
    ...
    void twoPlansOnOneChecklistItemStayTwoPlans() {
        ...
        service.create(TRIP_ID, USER_ID, new ItineraryService.Input(null, ChecklistCategory.LODGING, "Airbnb in Cusco", LocalDateTime.of(2026, 10, 27, 15, 0), LocalDateTime.of(2026, 10, 28, 11, 0), null, new BigDecimal("150.00"), "EUR", List.of()));
        service.create(TRIP_ID, USER_ID, new ItineraryService.Input(null, ChecklistCategory.LODGING, "Another airbnb in Cusco", LocalDateTime.of(2026, 10, 28, 15, 0), LocalDateTime.of(2026, 10, 30, 11, 0), null, new BigDecimal("200.00"), "EUR", List.of()));
    ...
    void aSingleNightStayIsJustOneEntry() {
        ...
        service.create(TRIP_ID, USER_ID, new ItineraryService.Input(null, ChecklistCategory.LODGING, "Hostel in Lima", LocalDateTime.of(2026, 10, 24, 20, 0), LocalDateTime.of(2026, 10, 25, 10, 0), null, null, null, List.of()));
    ...
    void anEntryThatIsNotLodgingIsNeverSpread() {
        ...
        service.create(TRIP_ID, USER_ID, new ItineraryService.Input(null, ChecklistCategory.TRANSPORTATION, "Flight LAX to LIM", LocalDateTime.of(2026, 10, 24, 22, 0), LocalDateTime.of(2026, 10, 25, 8, 0), null, null, null, List.of()));
    ...
    void aPatchThatSaysNothingAboutTimeLeavesTheFlagAlone() {
        ...
        service.update(TRIP_ID, USER_ID, entry.getId(), new ItineraryService.Input(
                null, null, "Dinner at the market", null, null, null, null, null, null));
